...
(function(E) {
    ...
    function h() {
        ...
        if (!a) {
            ...
            E("#smsContent").attr("disabled", "disabled").css({
                "resize": "none"
            });
    ...
    function M(X, Y) {
        ...
        window.parent.$.fn.fetionHintWindow({
            modal: W
        }).show(X, "提示", "OK");
    }
    function w() {
        ...
        try {
            ...
            K.find("li[uid]").each(function() {
                var an = E(this).attr("uid"),
                am = E(this).attr("isdirectsms");
                var al = aa.get(an);
            ...
            function aj() {
                ...
                am.data = {
                    ...
                    "Message": ak,
                    "Receivers": X.join(","),
                    "ssid": window.parent.__sessionId
                };
                if (ab) {
                ...
                am.success = function(ao, ap) {
                    ...
                    if (typeof ao.rc == "number") {
                        ...
                        case 4865:
                            ...
                            break;
                        case 494:
                            M("您的飞信账号处于系统保护状态，限制了该功能的使用。<br>请手机发送短信U到12520解除限制后重新登录。");
                            break;
                        default:
                            M("系统错误请重试！");
                            break;
                ...
                an.success = function(ap, aq) {
                    ...
                    if ( !! ap && typeof ap.rc == "number") {
                        ...
                        case 999:
                            ...
                            switch (ap.rv) {
                            case 1:
                                M("对不起，你发送直接短信的数量已超过上限50条/小时，请稍后再试。");
                                break;
                            case 2:
                                M("对不起，你今天发送直接短信的数量已达上限，请明天继续使用。");
                                break;
                            case 3:
                                M("对不起，你本月发送直接短信的数量已达上限，请下个月再继续使用。");
                                break;
                            }
                            break;
                        default:
