...
public class SendMail
{
    ...
    public boolean addFileAffix(String filename)
    {
        ...
        try
        {
            //             String filnames = new String(filename.getBytes("iso8859-1"), "UTF-8");
            BodyPart bp = new MimeBodyPart();
    ...
    * @throws MessagingException 
    ...
    public static void main(String[] args) throws MessagingException
    {
         ...
         *************切切注意********
         */
        SendMail themail = new SendMail("smtp.163.com");//这里以新浪邮箱为例子 
        ...
        themail.setTo("710022315@qq.com");//收件人地址 
        //        themail.setTo("paul5-5@163.com");
        //         themail.setTo("1984392805@qq.com");
